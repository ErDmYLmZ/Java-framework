...
public class List01 {
	...
	public static void main(String[] args) {
		...
		// 2.Way: using Arrays.asList() method
		// we will use Arrays.asList() method to convert an array to a list.
		// But when you use Arrays.asLists() method data types of elements should be "non-primitive"
		 ...
		 * the list is created from an array, and the list has some array features. The significant
		 * array feature is to fix in length. So if you create a list from an array, you cannot use 
		 * any list method which changes the size.
		 */
//		l3c.add(7);
//		System.out.println(l3c);
...
//       set, get, contains and similar methods can be used
