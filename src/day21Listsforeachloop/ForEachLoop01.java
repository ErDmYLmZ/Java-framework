...
public class ForEachLoop01 {
	...
	public static void main(String[] args) {
		...
		//Print the character whose ASCII values are even
		...
		// If you see any character whose ASCII value is less than 100 stop printing and give and error message
		...
		//Arrays can be used for-each loop as well
