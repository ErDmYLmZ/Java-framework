package day26inheritanceoverriding;
		 ...
		 * 5) super() can call constructors just from "parent class" not from "grandparent classes"
		 */

public class Bird extends day26inhertianceoverriding.Mammal {
	...
	public Bird() {
		super (3); ///super() is used to call a specific constructor from parent class
