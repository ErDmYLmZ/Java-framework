...
public class Student {
	...
	/*
	 	...
	 	2)To read the value of hidden variables, we create "getters", and by using "getters" 
        ...
        Note:Getter method names start with "get" followed by "variable name"
             ...
             But if the variable is "boolean", getter method names start with "is" followed 
             by "variable name"
       ...
       Note: a)The return type of getter is same with the return type of the variable
             ...
             c)Getters do not use "parameters" but setters must use parameters to update the 
             existing value
	*/
