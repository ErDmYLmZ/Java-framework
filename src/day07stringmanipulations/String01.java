...
public class String01 {
	...
	public static void main(String[] args) {
		 ...
		 * // 1- equals()==> Compare the Strings with cases and it returns boolean 
				...
				System.out.println(str6.charAt(25)); // "StringIndexOutOfBoundsException" ==> if you use an 
				                                     //index grater than the last index you will get that Exception 
		...
		String str7 = scan.nextLine().toLowerCase();
